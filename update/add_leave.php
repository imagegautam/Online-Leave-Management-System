...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
		$alert_message = "Leave type added successfully!";
        $modal_button = "../controller/add_leave.php";
    } else {
		$alert_message = "Failed to add Leave!!!...";
        $modal_button = "../controller/add_leave.php";
	}
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <form action="../controller/add_leave.php" method="post">
